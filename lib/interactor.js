...
var listenerInitialPageLoaded = function(oIncomingMessage, strPage){
...
function Interactor(oConfig){
	...
	this.on(Interactor.availableEvents.initialPageLoaded, listenerInitialPageLoaded.bind(this));
}
